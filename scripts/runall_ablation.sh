...
./scripts/gather5.sh "./scripts/pong_ablation_runner.sh alignment_penalty" 
./scripts/gather5.sh "./scripts/pong_ablation_runner.sh alignment_margin" 
./scripts/gather5.sh "./scripts/pong_ablation_runner.sh alignment_penalty_margin" 
